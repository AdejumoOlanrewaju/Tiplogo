"""
Django settings for tiplogo project.
...
SECRET_KEY = 'django-insecure-tc_%+7z=+8zqd$1fhghv=o6arj#2rmaihhg$w56@pimqf4%uro'
...
WSGI_APPLICATION = 'tiplogo.wsgi.application'
